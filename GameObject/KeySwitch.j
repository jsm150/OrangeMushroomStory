...
//---------------------------------------------------------------
        ...
        //! runtextmacro for("set j = 0", "j < 2")
            call posList2.AddFirst(blockLocation.create(-17920 + (128 * j), 24064))
            call posList2.AddFirst(blockLocation.create(-17024 + (128 * j), 24064))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-16512, 23552))
        call posList.AddFirst(blockLocation.create(-16384, 23424))
        call posList.AddFirst(blockLocation.create(-15872, 24448))
        call posList.AddFirst(blockLocation.create(-15744, 24320))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.AddAction(posList2, "Create")
        call keyMapManager.SaveEvent()
        ...
        set posList = blockLocationLinkedList.create()
        set posList2 = blockLocationLinkedList.create()
        call posList2.AddFirst(blockLocation.create(-17920, 24192))
        //! runtextmacro for("set j = 0", "j < 5")
        call posList.AddFirst(blockLocation.create(-18304 + (128 * j), 23808))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-16640, 23424))
        call posList.AddFirst(blockLocation.create(-16512, 23296))
        //! runtextmacro for("set j = 0", "j < 3")
        call posList.AddFirst(blockLocation.create(-17024 + (128 * j), 22016))
        //! runtextmacro for_end("set j = j + 1")
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-17024 + (128 * j), 22272))
        call posList.AddFirst(blockLocation.create(-12288 + (128 * j), 23936))
        call posList.AddFirst(blockLocation.create(-18560, 22912 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-15488, 22784))
        call posList.AddFirst(blockLocation.create(-15104, 22400))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.AddAction(posList2, "Create")
        call keyMapManager.SaveEvent()
        ...
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-16768, 22400 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-15872, 22400 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-15232, 22400))
        call posList.AddFirst(blockLocation.create(-16512, 22784))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key15_2_004)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-18816, 22784))
        call posList.AddFirst(blockLocation.create(-16768, 21504))
        //! runtextmacro for("set j = 0", "j < 4")
        call posList.AddFirst(blockLocation.create(-15872, 22656 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        ...
        call keyMapManager.Register()
        //---------------------------------------------------------------
        call keyMapManager.Setting(15, 3)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key15_3_001)
        set posList = blockLocationLinkedList.create()
        ...
        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key15_3_002)
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-12288 + (128 * j), 23936))
        ...
        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key15_3_003)
        set posList = blockLocationLinkedList.create()
        ...
        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key15_3_004)
        set posList = blockLocationLinkedList.create()
        ...
        call keyMapManager.Register()
        //---------------------------------------------------------------
        call keyMapManager.Setting(15, 4)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key15_4_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-18304, 26752))
        call posList.AddFirst(blockLocation.create(-15872, 25728))
        call posList.AddFirst(blockLocation.create(-15872, 25856))
        call posList.AddFirst(blockLocation.create(-15104, 27136))
        call posList.AddFirst(blockLocation.create(-14208, 26624))
        call posList.AddFirst(blockLocation.create(-14464, 25344))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key15_4_002)
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-16768, 26240 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-17024, 26624 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-15488, 26368 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-13824, 26752 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-16768, 26624))
        call posList.AddFirst(blockLocation.create(-15872, 25600))
        call posList.AddFirst(blockLocation.create(-15616, 26240))
        call posList.AddFirst(blockLocation.create(-14208, 26496))
        call posList.AddFirst(blockLocation.create(-14080, 26624))
        call posList.AddFirst(blockLocation.create(-14080, 27008))
        call posList.AddFirst(blockLocation.create(-14080 + 128, 27008))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key15_4_003)
        set posList = blockLocationLinkedList.create()
        set posList2 = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-18688, 26752 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-18048, 25856 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-18560 + (128 * j), 27008))
        call posList.AddFirst(blockLocation.create(-17024 + (128 * j), 26112))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-15488, 25088))
        call posList.AddFirst(blockLocation.create(-14464, 27520))
        call posList.AddFirst(blockLocation.create(-14464, 27776))
        call posList.AddFirst(blockLocation.create(-14464, 27776 + 128))
        call posList.AddFirst(blockLocation.create(-14720, 27776))
        call posList.AddFirst(blockLocation.create(-13952, 26624))
        call posList.AddFirst(blockLocation.create(-16768, 26496))
        call posList.AddFirst(blockLocation.create(-16768 + 128, 26496))
        call posList2.AddFirst(blockLocation.create(-16000, 26624))
        call posList2.AddFirst(blockLocation.create(-16000, 26624 + 128))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.AddAction(posList2, "Create")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key15_4_004)
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-19584 + (128 * j), 27264))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-19200, 26240))
        call posList.AddFirst(blockLocation.create(-19200 + 128, 26240))
        call posList.AddFirst(blockLocation.create(-19584, 24960))
        call posList.AddFirst(blockLocation.create(-15616, 25216))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.Register()
        //---------------------------------------------------------------
        call keyMapManager.Setting(15, 5)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key15_5_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-11136, 19200))
        call posList.AddFirst(blockLocation.create(-11648, 19712))
        call posList.AddFirst(blockLocation.create(-9728, 20864))
        call posList.AddFirst(blockLocation.create(-9600, 20992))
        call posList.AddFirst(blockLocation.create(-10368, 20224))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key15_5_002)
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-11904, 19584 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-10880, 20992 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-10496, 19968 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-10880, 20352 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-11904 + (128 * j), 19840))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-10496, 21248))
        call posList.AddFirst(blockLocation.create(-10496, 20480))
        call posList.AddFirst(blockLocation.create(-10240, 19584))
        call posList.AddFirst(blockLocation.create(-11648, 19584))
        call posList.AddFirst(blockLocation.create(-10880, 20224))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key15_5_003)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-9984, 19456))
        call posList.AddFirst(blockLocation.create(-9856, 19456))
        call posList.AddFirst(blockLocation.create(-12160, 19584))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key15_5_004)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-14080, 19584))
        call posList.AddFirst(blockLocation.create(-14080, 19584 + 128))
        call posList.AddFirst(blockLocation.create(-13696, 20224))
        call posList.AddFirst(blockLocation.create(-13184, 19456))
        call posList.AddFirst(blockLocation.create(-13056, 20096))
        call posList.AddFirst(blockLocation.create(-12928, 20352))
        call posList.AddFirst(blockLocation.create(-9856, 19072))
        call posList.AddFirst(blockLocation.create(-9728, 19968))
        call posList.AddFirst(blockLocation.create(-9728, 21248))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.Register()
        //---------------------------------------------------------------
        call keyMapManager.Setting(15, 6)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key15_6_001)
        set posList = blockLocationLinkedList.create()
        set posList2 = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 7")
        call posList.AddFirst(blockLocation.create(-18560 + (128 * j), 20224))
        //! runtextmacro for_end("set j = j + 1")
        call posList2.AddFirst(blockLocation.create(-18688, 20608))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.AddAction(posList2, "Create")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key15_6_002)
        set posList = blockLocationLinkedList.create()
        set posList2 = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 3")
        call posList.AddFirst(blockLocation.create(-17664, 17920 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-17920, 20608))
        call posList.AddFirst(blockLocation.create(-17920 + 128, 20608))
        call posList2.AddFirst(blockLocation.create(-16384, 19584))
        //! runtextmacro for("set j = 0", "j < 2")
        call posList2.AddFirst(blockLocation.create(-14848, 20480 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.AddAction(posList2, "Create")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key15_6_003)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-18304, 16896))
        call posList.AddFirst(blockLocation.create(-17792, 17280))
        call posList.AddFirst(blockLocation.create(-15232, 17792))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key15_6_004)
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 3")
        call posList.AddFirst(blockLocation.create(-19072, 18560 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-18688, 18560 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-18176, 17664 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-15872, 17152 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-15744, 17152 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        ...
        call keyMapManager.Register()         
        //---------------------------------------------------------------
        call keyMapManager.Setting(15, 7)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key15_7_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-14208, 18176))
        call posList.AddFirst(blockLocation.create(-12032, 18432))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key15_7_002)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-14592, 17792))
        call posList.AddFirst(blockLocation.create(-14464, 17920))
        call posList.AddFirst(blockLocation.create(-14336, 18176))
        call posList.AddFirst(blockLocation.create(-13056, 17280))
        call posList.AddFirst(blockLocation.create(-13056, 18176))
        call posList.AddFirst(blockLocation.create(-11520, 18048))
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-12672, 17664 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-12032, 17408 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key15_7_003)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-14464, 16960))
        call posList.AddFirst(blockLocation.create(-11264, 18688))
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-13696 + (128 * j), 16896))
        call posList.AddFirst(blockLocation.create(-11776, 17664 + (128 * j)))
        call posList.AddFirst(blockLocation.create(-11520, 18432 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key15_7_004)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-14464, 16832))
        call posList.AddFirst(blockLocation.create(-11392, 16896))
        call posList.AddFirst(blockLocation.create(-11264, 17024))
        //! runtextmacro for("set j = 0", "j < 2")
        call posList.AddFirst(blockLocation.create(-14592 + (128 * j), 17088))
        call posList.AddFirst(blockLocation.create(-12032, 17152 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        ...
        call keyMapManager.Register() 
        //---------------------------------------------------------------
        call keyMapManager.Setting(15, 8)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key15_8_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-16000, 13440))
        call posList.AddFirst(blockLocation.create(-15872, 13568))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key15_8_002)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-17024, 13696))
        call posList.AddFirst(blockLocation.create(-17024, 13824))
        call posList.AddFirst(blockLocation.create(-17024, 13824 + 128))
        call posList.AddFirst(blockLocation.create(-16768, 13696))
        call posList.AddFirst(blockLocation.create(-17536, 13696))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        
        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key15_8_003)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-17920, 12928))
        call posList.AddFirst(blockLocation.create(-17920 + 128, 12928))
        call posList.AddFirst(blockLocation.create(-18048, 14976))
        call posList.AddFirst(blockLocation.create(-16384, 13056))
        call posList.AddFirst(blockLocation.create(-16256, 12928))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key15_8_004)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-16256, 13184))
        call posList.AddFirst(blockLocation.create(-15360, 13696))
        call posList.AddFirst(blockLocation.create(-15360, 14464))
        call posList.AddFirst(blockLocation.create(-16384, 15616))
        call posList.AddFirst(blockLocation.create(-18304, 13568))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        ...
        //---------------------------------------------------------------
        call keyMapManager.Setting(16, 2)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key16_2_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-9984, 12672))
        call posList.AddFirst(blockLocation.create(-9984 + 128, 12672))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        ...
        //---------------------------------------------------------------
        call keyMapManager.Setting(16, 3)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key16_3_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-10112, 9856))
        call posList.AddFirst(blockLocation.create(-10112, 9856 + 128))
        call posList.AddFirst(blockLocation.create(-10112, 9856 + 256))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key16_3_002)
        set posList = blockLocationLinkedList.create()
        ...
        //---------------------------------------------------------------
        call keyMapManager.Setting(16, 4)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key16_4_001)
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 6")
            call posList.AddFirst(blockLocation.create(-16896, 10112 + (128 * j)))
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-17152, 10752))
        call posList.AddFirst(blockLocation.create(-17152 + 128, 10752))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key16_4_002)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-14976, 8448))
        call posList.AddFirst(blockLocation.create(-14976 + 128, 8448))
        call posList.AddFirst(blockLocation.create(-13568, 7936))
        call posList.AddFirst(blockLocation.create(-13568, 7936 + 128))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key16_4_003)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-16896, 9984))
        call posList.AddFirst(blockLocation.create(-16896 + 128, 9984))
        call posList.AddFirst(blockLocation.create(-16896 + 256, 9984))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key16_4_004)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-13312, 10112))
        ...
        //---------------------------------------------------------------
        call keyMapManager.Setting(17, 1)
        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key17_1_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-10496, -29952))
        call posList.AddFirst(blockLocation.create(-10496, -29952 + 128))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        ...
        //---------------------------------------------------------------
        call keyMapManager.Setting(17, 2)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key17_2_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-16000, -27520))
        call posList.AddFirst(blockLocation.create(-16000, -27520 + 128))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key17_2_002)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-17024, -27904))
        call posList.AddFirst(blockLocation.create(-17024, -27904 + 128))
        call posList.AddFirst(blockLocation.create(-16000, -28160))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key17_2_003)
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 5")
            call posList.AddFirst(blockLocation.create(-14080 + (128 * j), -30080))
        //! runtextmacro for_end("set j = j + 1")
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        ...
        //---------------------------------------------------------------
        call keyMapManager.Setting(17, 3)

        call keyMapManager.CreateEvent(RED_KEY_ID, gg_rct_Key17_3_001)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-10880, -24576))
        call posList.AddFirst(blockLocation.create(-10880, -24576 + 128))
        call posList.AddFirst(blockLocation.create(-10880, -24576 + 256))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(YELLOW_KEY_ID, gg_rct_Key17_3_002)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-11776, -24320))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(BLUE_KEY_ID, gg_rct_Key17_3_003)
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-13056, -25728))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()

        call keyMapManager.CreateEvent(WHITE_KEY_ID, gg_rct_Key17_3_004)
        set posList = blockLocationLinkedList.create()
        //! runtextmacro for("set j = 0", "j < 4")
            call posList.AddFirst(blockLocation.create(-16000 + (128 * j), -25600))
        //! runtextmacro for_end("set j = j + 1")
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
