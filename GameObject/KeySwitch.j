...
//---------------------------------------------------------------
        ...
        call posList.AddFirst(blockLocation.create(-15488, 24320))
        call posList.AddFirst(blockLocation.create(-15360, 24192))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.AddAction(posList2, "Create")
        call keyMapManager.SaveEvent()
        ...
        call posList.AddFirst(blockLocation.create(-18048, 25600 + (128 * j)))
        ...
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-17280, 18304))
        call posList.AddFirst(blockLocation.create(-17024, 18816))
        call posList.AddFirst(blockLocation.create(-16384, 19072))
        ...
        //! runtextmacro for_end("set j = j + 1")
        call posList.AddFirst(blockLocation.create(-15488, 16896))
        call keyMapManager.AddAction(posList, "Remove")
        call keyMapManager.SaveEvent()
        ...
        set posList = blockLocationLinkedList.create()
        call posList.AddFirst(blockLocation.create(-17792, 12928))
