library Arrow initializer init needs Calculation
    ...
    private function Main takes nothing returns nothing
        ...
        if Stage_Loading == false and GravityChanger_Loading == false and (MushroomType(types) or types == 'opeo' or types == 'ogru' or types == 'otau' or types == 'ocat' or types == 'ohun' or types == 'o000' or types == 'h00S' or types == 'h00T' or types == 'o006' or types == 'o005') then
    ...
    private function init takes nothing returns nothing
        ...
        call SetInputRect(t, gg_rct_Arrow246, 350)
        call SetInputRect(t, gg_rct_Arrow247, 150)
        call SetInputRect(t, gg_rct_Arrow248, 0)
        call SetInputRect(t, gg_rct_Arrow249, 0)
        call SetInputRect(t, gg_rct_Arrow250, 180)
        call SetInputRect(t, gg_rct_Arrow251, 220)
        call SetInputRect(t, gg_rct_Arrow252, 270)
        call SetInputRect(t, gg_rct_Arrow253, 270)
        call SetInputRect(t, gg_rct_Arrow254, 270)
        call SetInputRect(t, gg_rct_Arrow255, 0)
        call SetInputRect(t, gg_rct_Arrow256, 70)
        call SetInputRect(t, gg_rct_Arrow257, 180)
        call SetInputRect(t, gg_rct_Arrow258, 180)
        call SetInputRect(t, gg_rct_Arrow259, 0)
        call SetInputRect(t, gg_rct_Arrow260, 180)
        call SetInputRect(t, gg_rct_Arrow261, 180)
        call SetInputRect(t, gg_rct_Arrow262, 180)
        call SetInputRect(t, gg_rct_Arrow263, 0)
        call SetInputRect(t, gg_rct_Arrow264, 0)
        call SetInputRect(t, gg_rct_Arrow265, 0)
        call SetInputRect(t, gg_rct_Arrow266, 180)
        call SetInputRect(t, gg_rct_Arrow267, 135)
        call SetInputRect(t, gg_rct_Arrow268, 180)
        call SetInputRect(t, gg_rct_Arrow269, 180)
        call SetInputRect(t, gg_rct_Arrow270, 0)
        call SetInputRect(t, gg_rct_Arrow271, 135)
        call SetInputRect(t, gg_rct_Arrow272, 270)
        call SetInputRect(t, gg_rct_Arrow273, 150)
        call SetInputRect(t, gg_rct_Arrow274, 90)
        call SetInputRect(t, gg_rct_Arrow275, 90)
        call SetInputRect(t, gg_rct_Arrow276, 180)
        call SetInputRect(t, gg_rct_Arrow277, 180)
        call SetInputRect(t, gg_rct_Arrow278, 220)
        call SetInputRect(t, gg_rct_Arrow279, 0)
        call SetInputRect(t, gg_rct_Arrow280, 180)
        call SetInputRect(t, gg_rct_Arrow281, 270)
