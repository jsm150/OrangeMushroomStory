library DragonStone initializer Init needs Key
    ...
    private function Init takes nothing returns nothing
        ...
        //! runtextmacro for_end("set i = i + 1")
        //! runtextmacro for("set i = 0", "i < 4")
        call Register(-14848, 16896 + (128 * i), RefreStageTerrain)
        call Register(-16896 + (128 * i), 19712, RefreStageTerrain)
        call Register(-15744, 19968 + (128 * i), RefreStageTerrain)
        //! runtextmacro for_end("set i = i + 1")
        call Register(-17920, 17024, RefreStageTerrain)
        call Register(-17536, 18816, RefreStageTerrain)
        call Register(-17408, 18816, RefreStageTerrain)
        call Register(-17408, 18816 + 128, RefreStageTerrain)
        //15 - 7
        ...
        call Register(-18304, 12928, RefreStageTerrain)
