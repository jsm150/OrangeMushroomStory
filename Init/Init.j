scope initialize initializer init
    ...
    private function Quest takes nothing returns nothing
        ...
        call CreateQuestBJ( bj_QUESTTYPE_OPT_DISCOVERED, "10.6~11.0", s, "ReplaceableTextures\\CommandButtons\\BTNs_OrangeMushroomPinkIcon.blp" )
        set s = "10.2\n"
        ...
        set s = s + "아직은 골드리프의 사용처가 없습니다. 추후에 추가하도록 하겠습니다.\n"
        set s = s + "\n"
