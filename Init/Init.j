scope initialize initializer init
    ...
    private function Quest takes nothing returns nothing
        ...
        set s = s + "- 엘린숲 스테이지 입구가 변경되었습니다.\n"
        set s = s + "- 카페 스킨이 수정되었습니다.\n"
        set s = s + "- 히든스킨 이벤트가 추가되었습니다. 자세한건 F9를 참고해 주십시오.\n"
        set s = s + "\n"
        set s = s + "11.3\n"
        ...
        set s = s + "\n"
        set s = s + "11.6\n"
        set s = s + "- 월드 첼린지2에서 스테이지가 넘어가지 않던 버그를 수정했습니다.\n"
        set s = s + "- 월드 첼린지2의 스테이지들이 수정되었습니다. \n"
        set s = s + "\n"
        set s = s + "11.7\n"
        ...
        set s = s + "\n"
        set s = s + "10.9\n"
        set s = s + "- 아랫마을 3-6, 3-7 맵이 수정되었습니다.\n"
        set s = s + "- 대기실에서 최신버전을 다운로드 할 수 있는 링크를 추가했습니다.\n"
        set s = s + "\n"
        set s = s + "11.0\n"
        set s = s + "- 카페 스킨이 오브젝트와 제대로 상호작용 하지 못하던 버그를 수정했습니다.\n"
        set s = s + "- 인벤토리의 UI가 개선되었습니다.\n"
        set s = s + "- 재화 \"골드리프\"가 추가되었습니다. 자세한건 F9를 참고해 주십시오.\n"
        set s = s + "- -재연결 / -rec 명령어가 추가되었습니다. 자세한건 F9를 참고해 주십시오.\n"
        set s = s + "\n"
        set s = s + "11.1\n"
        set s = s + "- 상점이 추가되었습니다.\n"
        ...
        set s = s + "\n"
        set s = s + "-재연결 / -rec\n"
        set s = s + "서버와 다시 연결을 시도합니다.\n"
        set s = s + "서버와 연결이 끊겨있는 상태에서만 가능합니다.\n"
        set s = s + "\n"
        set s = s + "-상점 / -shop\n"
        set s = s + "상점 UI를 오픈합니다.\n"
        ...
        set s = "● 용 비석\n"
        set s = s + "-용 비석을 활성화 시키면 특정 블럭이 생성됩니다.\n"
        set s = s + "-용 비석에서 방향키(↓)를 누르면 활성화 시킬 수 있습니다.\n"
        set s = s + "-자신이 무엇을 밟고 있을때만 작동합니다.\n"
        set s = s + "-활성화 된 상태에서 다시 방향키(↓)를 누를 시 비활성화됩니다.\n"
        set s = s + "\n"
        set s = s + "● 뮤테\n"
        set s = s + "-아래 방향키를 누르면 같은 색의 뮤테에 있는 오브젝트를 6칸 띄웁니다.\n"
        set s = s + "\n"
        set s = s + "● 레쉬\n"
        ...
        set s = "골드리프는 이 게임에서 사용할 수 있는 재화입니다.\n"
        set s = s + "이 게임의 엔딩에 도달했을 때, 일정량의 골드리프를 얻을 수 있습니다.\n"
        set s = s + "현재 자신이 소지하고 있는 골드리프의 개수는 인벤토리 에서 확인할 수 있습니다.\n"
        set s = s + "골드리프는 상점에서 아이템을 구매할 때 사용할 수 있습니다.\n"
        set s = s + "\n"
        set s = s + "아래는 클리어 월드당 얻을 수 있는 골드리프의 개수 입니다.\n"
        set s = s + "핑크핑크 : 150\n"
        set s = s + "지하철 : 200\n"
        set s = s + "발렌타인 데이 : 200\n"
        set s = s + "해변 : 300\n"
        ...
        set s = TeamColor[7] + "쉬움|r : 1.53%, " + TeamColor[5] + "보통|r : 1.15%, " + TeamColor[6] + "어려움|r : 0.77%," + TeamColor[1] + " 매우어려움|r : 0.38%\n\n"
        set s = s + "--- 핑크핑크 ---:\n"
        set s = s + "  3-1 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-2 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-3 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-4 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-5 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-6 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-7 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-8 : " + TeamColor[7] + "쉬움|r( 1.53% )\n\n"
        set s = s + "--- 도시 ---:\n"
        set s = s + "  3-1 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-2 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-3 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        ...
        set s = s + "  3-3 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-4 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-5 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-6 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-7 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-8 : " + TeamColor[7] + "쉬움|r( 1.53% )\n\n"
        set s = s + "--- 코크타운 ---:\n"
        set s = s + "  3-1 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        set s = s + "  3-2 : " + TeamColor[7] + "쉬움|r( 1.53% )\n"
        ...
        set s = s + "  3-8 : " + TeamColor[7] + "쉬움|r( 1.53% )\n\n"
        set s = s + "--- 월드 챌린지 ---:\n"
        set s = s + "  3-1 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-2 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-3 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-4 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-5 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-6 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-7 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n\n"
        ...
        set s = TeamColor[7] + "쉬움|r : 1.53%, " + TeamColor[5] + "보통|r : 1.15%, " + TeamColor[6] + "어려움|r : 0.77%," + TeamColor[1] + " 매우어려움|r : 0.38%\n\n"
        set s = s + "--- 카페 ---:\n"
        set s = s + "  3-1 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-2 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-3 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-4 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-5 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-6 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-7 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-8 : " + TeamColor[6] + "어려움|r( 0.77% )\n\n"
        set s = s + "--- 사막 ---:\n"
        set s = s + "  3-1 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-2 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-3 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-4 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-5 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-6 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-7 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-8 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n\n"
        set s = s + "--- 엘린 숲 ---:\n"
        set s = s + "  3-1 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-2 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-3 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-4 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-5 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n\n"
        ...
        set s = TeamColor[7] + "쉬움|r : 1.62%, " + TeamColor[5] + "보통|r : 1.15%, " + TeamColor[6] + "어려움|r : 0.77%," + TeamColor[1] + " 매우어려움|r : 0.38%\n\n"
        set s = s + "--- 얼음 동굴 ---:\n"
        set s = s + "  3-1 : " + TeamColor[5] + "보통|r( 1.15% )\n"
        set s = s + "  3-2 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        set s = s + "  3-3 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        ...
        set s = s + "--- 월드 첼린지 II ---:\n"
        set s = s + "  3-1 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-2 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-3 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-4 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-5 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n\n"
        ...
        set s = s + "  3-7 : " + TeamColor[1] + "매우 어려움|r( 0.38% )\n"
        set s = s + "  3-8 : " + TeamColor[6] + "어려움|r( 0.77% )\n"
        call CreateQuestBJ( bj_QUESTTYPE_REQ_DISCOVERED, "랜덤 월드 확률표5", s, "ReplaceableTextures\\CommandButtons\\BTNs_OrangeMushroomIcon.blp" )
